...
const CadastroAdm = () => {
  ...
  const fetchUsuarios = async () => {
    try {
      ...
      const response = await fetch('http://10.90.154.27:7010/api/Usuarios/ListarUsuarios');
      if (!response.ok) {
  ...
  useEffect(() => {
    const fetchTiposUsuario = async () => {
      try {
        ...
        const response = await fetch("http://10.90.154.27:7010/api/Tipos/ListarTipos");
        if (!response.ok) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://10.90.154.27:7010/api/Usuarios/CadastrarUsuario', {
        method: 'POST',
        headers: {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      let response = await fetch(`http://10.90.154.27:7010/api/Usuarios/DeletarUsuario?id=${id}`, {
        method: 'DELETE',
      });
      ...
      response = await fetch(`http://10.90.154.27:7010/api/Usuarios/DeletarUsuario/${id}`, {
        method: 'DELETE',
      });
      ...
      response = await fetch(`http://10.90.154.27:7010/api/Usuarios/DeletarUsuario`, {
        method: 'DELETE',
